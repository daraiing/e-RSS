...
public class TeacherServiceImpl implements TeacherService {
	...
	public boolean insert(Teacher t) throws MessageGenericException {
		if (teacherRepository.findOne(t.getTid())!=null) {
			throw new MessageGenericException("ERR_TE-INSERT", "already exist in the database",403);
		}
	...
	public boolean update(Teacher t) throws MessageGenericException {
		...
		if(tOld!=null){
			...
			throw new MessageGenericException("ERR_TE-UPDATE", "'tid:"+t.getTid()+"' not define!",409);
		}
	}
